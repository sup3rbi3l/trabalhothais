...
class claroApp(MDApp):
    ...
    def organiza_dados(self):
        ...
        resultados = Workbook()
        resultados.worksheets[0].title = 'Dados P1'
        resultados.create_sheet(title="Dados P2")
        resultados.create_sheet(title="Contratos não encontrados")
        resultados.create_sheet(title="Estornos")
        ...
        wb_c_ativo = resultados.worksheets[2]
        ...
        estorno = resultados.worksheets[3]
                ...
                for linha_banco in banco:
                    ...
                    if linha_banco[1].value == linha_P[19].value and  linha_P[0].value[0:10]== linha_banco[2].value :
                        ...
                        for row in wap1:
                            print(vendedor)
                            print(row[0].value)
                            if row[0].value == vendedor and vendedor != None and len(vendedor) != 0:
                                row[4].value +=1
                                row[5].value += comicao
                                row[6].value += comicao_com_fator
        ...
        resultados.save('resultado.xlsx')    
