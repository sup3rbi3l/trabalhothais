...
tabela = 0 
for grupo1 in df_Grupo.worksheets:
    ...
    for row in grupo1:
        ...
        #######print(grupo1.title[-4:])
        #print(row[contrato_row].value)
        #print(row[data_intalacao_row].value)
        #print(row[vendedor_row].value)
        #print(row[cidade_row].value)
        #print(row[instalado_row].value)
        
        
        if row[0].value == None or grupo1.title == 'dados':
                break
        
        elif row[cidade_row].value == 'Cidade' or row[contrato_row].value == '---' or row[contrato_row].value == None or row[instalado_row].value != 'INSTALADA' or row[data_instalacao_row].value == None or (row[cidade_row].value == None and row[cod_cidade_row].value == None):
            pass
        
        else:
            
            if row[cod_cidade_row].value != None:
...
for row in ag:
    ...
    for i in range(1,26):
        ...
        if ag.cell(row=1,column=i).value == 'DATA DA INSTALAÇÃO' or ag.cell(row=1,column=i).value == 'Dia inst':
            ...
            cidade_row=i-1
    #print(ag.title)
    #print(row[data_instalacao_row].value)
    #print(row[contrato_row].value)
    #print(row[instalado_row].value)
    #print(row[cidade_row].value)
    ...
    if row[cidade_row].value == 'Cidade' or row[cidade_row].value == '---' or row[cidade_row].value == None or row[cidade_row].value == None or (row[instalado_row].value != 'ok' and row[instalado_row].value != 'INSTALADA'):
