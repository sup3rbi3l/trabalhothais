...
P2 = Workbook()
P2_ativo = P2.active
with open('P2 setembro 2023.csv') as f:
...
with open('P1 setembro 2023.csv') as f:
    reader = csv.reader(f,delimiter=";")
...
df_Grup = Workbook()
df_Grupo = df_Grup.active
with open('vendas-27-12-2023-06-21-47-2147.csv',encoding="utf-8") as f:
    reader = csv.reader(f,delimiter=";")
...
wa['A1']='Vendedor'
wa['B1']='Total comição'
wa['C1']='Total franquia'
wa['D1']='Número de contratos'
wa['E1']='Número de estornos'
...
for row in df_Grupo:
    if row[4].value == 'CIDADE' or row[2].value == '---':
        pass
    else:
        if row[4].value == None:
            break
        
        contrato_completo = str (dados_cidades [row[4].value])+str(row[2].value)
        #print(row[5].value)
        ...
        for rows in P2_ativo:
            ...
            if rows[19].value == contrato_completo:
                ...
                #print('valor franquia',rows[2].value,contrato_completo, rows[0].value)
                
                for nome in wa:
                    
                    if row[5].value == nome[0].value:
                        have_name = True
