...
numeros_invalidos = [valor for valor in dados_cidades.values() if len(str(valor)) != 3]

print("Números com mais ou menos de três dígitos:", numeros_invalidos)
