...
class procuraContrato(MDApp):
    ...
    "Xaxim": '361',
        ...
        with open('P1 Fevereiro 2023.csv') as f:
        ...
        with open('P2 Fevereiro 2023.csv') as f:
            reader = csv.reader(f,delimiter=";")
            for row in reader:
